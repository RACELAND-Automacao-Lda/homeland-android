...
import io.homeland.companion.android.common.bluetooth.BluetoothUtils
...
import io.homeland.companion.android.common.sensors.LocationSensorManagerBase
...
import io.homeland.companion.android.database.AppDatabase
...
import io.homeland.companion.android.database.sensor.SensorSettingType
import io.homeland.companion.android.location.HighAccuracyLocationService
import io.homeland.companion.android.notifications.MessagingManager
...
class LocationSensorManager : LocationSensorManagerBase() {
    ...
    companion object {
        ...
        const val ACTION_REQUEST_LOCATION_UPDATES =
            "io.homeland.companion.android.background.REQUEST_UPDATES"
        const val ACTION_REQUEST_ACCURATE_LOCATION_UPDATE =
            "io.homeland.companion.android.background.REQUEST_ACCURATE_UPDATE"
        const val ACTION_PROCESS_LOCATION =
            "io.homeland.companion.android.background.PROCESS_UPDATES"
        const val ACTION_PROCESS_HIGH_ACCURACY_LOCATION =
            "io.homeland.companion.android.background.PROCESS_HIGH_ACCURACY_UPDATES"
        const val ACTION_PROCESS_GEO =
            "io.homeland.companion.android.background.PROCESS_GEOFENCE"
        const val ACTION_FORCE_HIGH_ACCURACY =
            "io.homeland.companion.android.background.FORCE_HIGH_ACCURACY"
    ...
    private suspend fun createGeofencingRequest(): GeofencingRequest {
        ...
        try {
            ...
            Log.e(TAG, "Error receiving zones from HomeLand", e)
        }
    ...
    override fun docsLink(): String {
        return "https://companion.home-land.io/docs/core/location"
    }
