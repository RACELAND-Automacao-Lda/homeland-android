package io.homeland.companion.android.settings.wear
...
import io.homeland.companion.android.databinding.ActivitySettingsWearBinding
import io.homeland.companion.android.settings.wear.views.SettingsWearMainView
...
class SettingsWearActivity : AppCompatActivity(), CapabilityClient.OnCapabilityChangedListener {
    ...
    override fun onPrepareOptionsMenu(menu: Menu?): Boolean {
        menu?.findItem(R.id.get_help)?.let {
            it.isVisible = true
            it.intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://companion.home-land.io/docs/wear-os/wear-os"))
        }
        return true
    }
    ...
    companion object {
        ...
        private const val PLAY_STORE_APP_URI =
            "market://details?id=io.homeland.companion.android"
