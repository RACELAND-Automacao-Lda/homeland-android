...
class SettingsWearViewModel @Inject constructor(
    ...
    override fun onCleared() {
        Wearable.getDataClient(getApplication<HomeLandApplication>()).removeListener(this)
    }
    ...
    fun sendHomeFavorites(favoritesList: List<String>) = viewModelScope.launch {
        val application = getApplication<HomeLandApplication>()
    ...
    fun sendAuthToWear(
        ...
        Wearable.getDataClient(getApplication<HomeLandApplication>()).putDataItem(putDataRequest).apply {
