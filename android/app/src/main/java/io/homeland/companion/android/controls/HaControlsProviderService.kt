...
import io.homeland.companion.android.util.RegistriesDataHandler
                        ...
                        controlIds.forEach {
                            try {
                                ...
                                if (entity != null) {
                                    ...
                                    Log.e(TAG, "Unable to get $it from HomeLand, null response.")
                                }
                            } catch (e: Exception) {
                                entities["ha_failed.$it"] = getFailedEntity(it, e)
                                Log.e(TAG, "Unable to get $it from HomeLand, caught exception.", e)
                            }
                        }
