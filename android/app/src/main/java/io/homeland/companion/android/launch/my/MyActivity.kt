package io.homeland.companion.android.launch.my
...
import io.homeland.companion.android.databinding.ActivityMyBinding
            ...
            binding.webview.apply {
                ...
                webViewClient = object : WebViewClient() {
                    override fun shouldOverrideUrlLoading(
                        ...
                        if (url.startsWith("homeland://navigate/")) {
                            startActivity(WebViewActivity.newInstance(context, url.removePrefix("homeland://navigate/")))
                            finish()
                            return true
                        }
                        return false
