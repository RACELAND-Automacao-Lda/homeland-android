package io.homeland.companion.android.nfc
...
import io.homeland.companion.android.nfc.views.TagReaderView
...
class TagReaderActivity : BaseActivity() {
    ...
    private suspend fun handleTag(url: Uri?, isNfcTag: Boolean) {
        // https://www.home-land.io/tag/5f0ba733-172f-430d-a7f8-e4ad940c88d7
