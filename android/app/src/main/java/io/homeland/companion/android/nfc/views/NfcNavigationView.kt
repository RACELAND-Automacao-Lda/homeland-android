package io.homeland.companion.android.nfc.views
...
import io.homeland.companion.android.nfc.NfcViewModel
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                ...
                actions = {
                    IconButton(onClick = {
                        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://companion.home-land.io/docs/integrations/universal-links"))
