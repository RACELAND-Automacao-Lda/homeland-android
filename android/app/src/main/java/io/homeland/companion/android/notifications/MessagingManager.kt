package io.homeland.companion.android.notifications
...
import io.homeland.companion.android.common.util.cancel
import io.homeland.companion.android.common.util.cancelGroupIfNeeded
import io.homeland.companion.android.common.util.generalChannel
import io.homeland.companion.android.common.util.getActiveNotification
...
import io.homeland.companion.android.database.settings.WebsocketSetting
import io.homeland.companion.android.sensors.BluetoothSensorManager
import io.homeland.companion.android.sensors.LocationSensorManager
import io.homeland.companion.android.sensors.NotificationSensorManager
import io.homeland.companion.android.sensors.SensorWorker
import io.homeland.companion.android.settings.SettingsActivity
import io.homeland.companion.android.util.UrlHandler
import io.homeland.companion.android.websocket.WebsocketManager
import io.homeland.companion.android.webview.WebViewActivity
        ...
        when (message) {
            ...
            COMMAND_SCREEN_ON -> {
                ...
                val wakeLock = powerManager?.newWakeLock(
                    ...
                    "HomeLand::NotificationScreenOnWakeLock"
                )
