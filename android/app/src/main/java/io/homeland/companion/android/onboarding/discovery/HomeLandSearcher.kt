...
class HomeLandSearcher constructor(
    private val nsdManager: NsdManager,
    private val wifiManager: WifiManager?,
    private val onInstanceFound: (instance: HomeLandInstance) -> Unit,
    private val onError: () -> Unit
) : NsdManager.DiscoveryListener, DefaultLifecycleObserver {

    companion object {
        private const val SERVICE_TYPE = "_home-land._tcp"

        private const val TAG = "HomeLandSearcher"
