...
class AppSensorManager : SensorManager {
    companion object {
        ...
        val currentVersion = SensorManager.BasicSensor(
            ...
            "mdi:android",
            docsLink = "https://companion.home-land.io/docs/core/sensors#current-version-sensor",
        ...
        val app_rx_gb = SensorManager.BasicSensor(
            ...
            docsLink = "https://companion.home-land.io/docs/core/sensors#app-data-sensors",
        ...
        val app_memory = SensorManager.BasicSensor(
            ...
            "mdi:memory",
            unitOfMeasurement = "GB",
            docsLink = "https://companion.home-land.io/docs/core/sensors#app-memory-sensor",
        ...
        val app_inactive = SensorManager.BasicSensor(
            ...
            "mdi:timer-outline",
            docsLink = "https://companion.home-land.io/docs/core/sensors#app-usage-sensors",
            entityCategory = SensorManager.ENTITY_CATEGORY_DIAGNOSTIC
        )
        ...
        val app_importance = SensorManager.BasicSensor(
            ...
            "mdi:android",
            docsLink = "https://companion.home-land.io/docs/core/sensors#app-importance-sensor",
            entityCategory = SensorManager.ENTITY_CATEGORY_DIAGNOSTIC
        )
    }
