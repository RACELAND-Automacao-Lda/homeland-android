...
class NotificationSensorManager : NotificationListenerService(), SensorManager {
    companion object {
        ...
        val lastNotification = SensorManager.BasicSensor(
            ...
            "mdi:bell-ring",
            docsLink = "https://companion.home-land.io/docs/core/sensors#last-notification",
        ...
        val lastRemovedNotification = SensorManager.BasicSensor(
            ...
            "mdi:bell-ring",
            docsLink = "https://companion.home-land.io/docs/core/sensors#last-removed-notification",
            updateType = SensorManager.BasicSensor.UpdateType.INTENT
        )
        val activeNotificationCount = SensorManager.BasicSensor(
            ...
            docsLink = "https://companion.home-land.io/docs/core/sensors#active-notification-count",
        ...
        private val mediaSession = SensorManager.BasicSensor(
            ...
            "mdi:play-circle",
            docsLink = "https://companion.home-land.io/docs/core/sensors#media-session-sensor"
        )
    }

    override fun docsLink(): String {
        return "https://companion.home-land.io/docs/core/sensors#notification-sensors"
    }
