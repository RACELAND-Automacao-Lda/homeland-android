...
class PhoneStateSensorManager : SensorManager {
    ...
    companion object {
        ...
        val phoneState = SensorManager.BasicSensor(
            ...
            "mdi:phone",
            docsLink = "https://companion.home-land.io/docs/core/sensors#phone-state-sensor",
    ...
    override fun docsLink(): String {
        return "https://companion.home-land.io/docs/core/sensors#cellular-provider-sensor"
    }
