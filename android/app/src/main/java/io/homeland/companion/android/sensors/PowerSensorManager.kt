...
class PowerSensorManager : SensorManager {
    companion object {
        ...
        private const val packageName = "io.homeland.companion.android"
        ...
        val interactiveDevice = SensorManager.BasicSensor(
            ...
            "mdi:cellphone",
            docsLink = "https://companion.home-land.io/docs/core/sensors#interactive-sensor",
        ...
        val doze = SensorManager.BasicSensor(
            ...
            "mdi:sleep",
            docsLink = "https://companion.home-land.io/docs/core/sensors#doze-sensor",
            entityCategory = SensorManager.ENTITY_CATEGORY_DIAGNOSTIC,
            updateType = SensorManager.BasicSensor.UpdateType.INTENT
        )
        val powerSave = SensorManager.BasicSensor(
            ...
            "mdi:battery-plus",
            docsLink = "https://companion.home-land.io/docs/core/sensors#power-save-sensor",
            entityCategory = SensorManager.ENTITY_CATEGORY_DIAGNOSTIC,
            updateType = SensorManager.BasicSensor.UpdateType.INTENT
        )
    }
