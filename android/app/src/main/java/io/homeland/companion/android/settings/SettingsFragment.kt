...
import io.homeland.companion.android.common.util.LocationPermissionInfoHandler
import io.homeland.companion.android.nfc.NfcSetupActivity
import io.homeland.companion.android.settings.controls.ManageControlsSettingsFragment
import io.homeland.companion.android.settings.language.LanguagesProvider
import io.homeland.companion.android.settings.log.LogFragment
import io.homeland.companion.android.settings.notification.NotificationChannelFragment
import io.homeland.companion.android.settings.notification.NotificationHistoryFragment
import io.homeland.companion.android.settings.qs.ManageTilesFragment
import io.homeland.companion.android.settings.sensor.SensorSettingsFragment
import io.homeland.companion.android.settings.sensor.SensorUpdateFrequencyFragment
import io.homeland.companion.android.settings.shortcuts.ManageShortcutsSettingsFragment
import io.homeland.companion.android.settings.ssid.SsidFragment
import io.homeland.companion.android.settings.wear.SettingsWearActivity
import io.homeland.companion.android.settings.websocket.WebsocketSettingFragment
import io.homeland.companion.android.settings.widgets.ManageWidgetsSettingsFragment
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        findPreference<Preference>("changelog_github")?.let {
            val link = if (BuildConfig.VERSION_NAME.startsWith("LOCAL"))
                "https://github.com/home-land/android/releases"
            else "https://github.com/home-land/android/releases/tag/${BuildConfig.VERSION_NAME.replace("-full", "").replace("-minimal", "")}"
            it.summary = link
        ...
        findPreference<Preference>("privacy")?.let {
            it.summary = "https://www.home-land.io/privacy/"
