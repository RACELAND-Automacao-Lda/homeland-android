package io.homeland.companion.android.settings.controls
...
import io.homeland.companion.android.settings.controls.views.ManageControlsView
...
class ManageControlsSettingsFragment : Fragment() {
    ...
    override fun onPrepareOptionsMenu(menu: Menu) {
        ...
        menu.findItem(R.id.get_help)?.let {
            it.isVisible = true
            it.intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://companion.home-land.io/docs/integrations/android-device-controls"))
        }
    }
