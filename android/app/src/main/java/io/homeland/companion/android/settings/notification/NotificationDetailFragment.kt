package io.homeland.companion.android.settings.notification
...
import io.homeland.companion.android.settings.notification.views.LoadNotification
...
class NotificationDetailFragment : Fragment() {
    ...
    override fun onPrepareOptionsMenu(menu: Menu) {
        ...
        menu.findItem(R.id.get_help)?.let {
            it.isVisible = true
            it.intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://companion.home-land.io/docs/notifications/notifications-basic"))
        }
    }
