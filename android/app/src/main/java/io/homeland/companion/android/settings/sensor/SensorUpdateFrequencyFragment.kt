...
import io.homeland.companion.android.settings.sensor.views.SensorUpdateFrequencyView
...
class SensorUpdateFrequencyFragment : Fragment() {
    ...
    override fun onPrepareOptionsMenu(menu: Menu) {
        ...
        menu.findItem(R.id.get_help)?.let {
            it.isVisible = true
            it.intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://companion.home-land.io/docs/core/sensors#android-sensors"))
        }
    }
