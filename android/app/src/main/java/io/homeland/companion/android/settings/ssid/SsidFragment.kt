package io.homeland.companion.android.settings.ssid
...
import io.homeland.companion.android.settings.ssid.views.SsidView
...
class SsidFragment : Fragment() {
    ...
    override fun onPrepareOptionsMenu(menu: Menu) {
        ...
        menu.findItem(R.id.get_help)?.let {
            it.isVisible = true
            it.intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://companion.home-land.io/docs/troubleshooting/networking#setting-up-the-app"))
        }
    }
