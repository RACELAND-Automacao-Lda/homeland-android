package io.homeland.companion.android.settings.websocket
...
import io.homeland.companion.android.settings.SettingViewModel
import io.homeland.companion.android.settings.websocket.views.WebsocketSettingView
...
class WebsocketSettingFragment : Fragment() {
    ...
    override fun onPrepareOptionsMenu(menu: Menu) {
        ...
        menu.findItem(R.id.get_help)?.let {
            it.isVisible = true
            it.intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://companion.home-land.io/docs/notifications/notification-local"))
        }
    }
