package io.homeland.companion.android.websocket
...
import io.homeland.companion.android.common.util.websocketChannel
import io.homeland.companion.android.common.util.websocketIssuesChannel
...
class WebsocketManager(
    ...
    private suspend fun createNotification(): Boolean {
        ...
        val notification = NotificationCompat.Builder(applicationContext, websocketChannel)
            ...
            .addAction(
                io.homeland.companion.android.R.drawable.ic_websocket,
