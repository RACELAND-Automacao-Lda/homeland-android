...
import io.homeland.companion.android.util.getAttribute
import io.homeland.companion.android.widgets.common.WidgetAuthenticationActivity
...
class ButtonWidget : AppWidgetProvider() {
    companion object {
        ...
        public const val CALL_SERVICE =
            "io.homeland.companion.android.widgets.button.ButtonWidget.CALL_SERVICE"
        private const val CALL_SERVICE_AUTH =
            "io.homeland.companion.android.widgets.button.ButtonWidget.CALL_SERVICE_AUTH"
        internal const val RECEIVE_DATA =
            "io.homeland.companion.android.widgets.button.ButtonWidget.RECEIVE_DATA"
        ...
        mainScope.launch {
            ...
            if (domain == null || service == null || serviceDataJson == null) {
                ...
                try {
                    ...
                    Log.d(TAG, "Sending service call to HomeLand")
