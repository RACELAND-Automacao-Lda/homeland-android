package io.homeland.companion.android.widgets.common
...
import io.homeland.companion.android.databinding.WidgetButtonConfigureDynamicFieldBinding
...
class WidgetDynamicFieldAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (fieldKey == "entity_id" && entities.isNotEmpty()) {
            ...
            // or for homeland domain, which should be able
            ...
            if (domain == ("homeland") || domain == null) {
