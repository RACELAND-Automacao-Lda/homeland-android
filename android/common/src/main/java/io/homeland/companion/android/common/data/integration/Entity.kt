...
fun <T> Entity<T>.getCoverPosition(): EntityPosition? {
    // https://github.com/home-land/frontend/blob/dev/src/dialogs/more-info/controls/more-info-cover.ts#L33
    return try {
        if (
            domain != "cover" ||
...
fun <T> Entity<T>.getFanSpeed(): EntityPosition? {
    // https://github.com/home-land/frontend/blob/dev/src/dialogs/more-info/controls/more-info-fan.js#L48
    return try {
...
fun <T> Entity<T>.getLightBrightness(): EntityPosition? {
    // https://github.com/home-land/frontend/blob/dev/src/dialogs/more-info/controls/more-info-light.ts#L90
    return try {
...
fun <T> Entity<T>.getLightColor(): Int? {
    // https://github.com/home-land/frontend/blob/dev/src/panels/lovelace/cards/hui-light-card.ts#L243
    return try {
