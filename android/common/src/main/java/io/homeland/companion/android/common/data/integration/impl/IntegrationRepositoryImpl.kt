package io.homeland.companion.android.common.data.integration.impl

import android.util.Log
import io.homeland.companion.android.common.BuildConfig
import io.homeland.companion.android.common.data.HomeLandVersion
import io.homeland.companion.android.common.data.LocalStorage
import io.homeland.companion.android.common.data.authentication.AuthenticationRepository
import io.homeland.companion.android.common.data.integration.ControlsAuthRequiredSetting
...
import io.homeland.companion.android.common.data.integration.IntegrationException
import io.homeland.companion.android.common.data.integration.IntegrationRepository
import io.homeland.companion.android.common.data.integration.SensorRegistration
import io.homeland.companion.android.common.data.integration.Service
import io.homeland.companion.android.common.data.integration.UpdateLocation
import io.homeland.companion.android.common.data.integration.ZoneAttributes
import io.homeland.companion.android.common.data.integration.impl.entities.EntityResponse
import io.homeland.companion.android.common.data.integration.impl.entities.FireEventRequest
import io.homeland.companion.android.common.data.integration.impl.entities.IntegrationRequest
import io.homeland.companion.android.common.data.integration.impl.entities.RateLimitRequest
import io.homeland.companion.android.common.data.integration.impl.entities.RateLimitResponse
import io.homeland.companion.android.common.data.integration.impl.entities.RegisterDeviceRequest
import io.homeland.companion.android.common.data.integration.impl.entities.SensorRequest
import io.homeland.companion.android.common.data.integration.impl.entities.ServiceCallRequest
import io.homeland.companion.android.common.data.integration.impl.entities.Template
import io.homeland.companion.android.common.data.integration.impl.entities.UpdateLocationRequest
...
class IntegrationRepositoryImpl @Inject constructor(
    ...
    companion object {
        private const val APP_ID = "io.homeland.companion.android"
        private const val APP_NAME = "HomeLand"
    ...
    override suspend fun getHomeLandVersion(): String {
    ...
    override suspend fun isHomeLandVersionAtLeast(
        year: Int,
        month: Int,
        release: Int
    ): Boolean {
        ...
        val version = HomeLandVersion.fromString(getHomeLandVersion())
    ...
    override suspend fun registerSensor(sensorRegistration: SensorRegistration<Any>) {
        val canRegisterCategoryStateClass = isHomeLandVersionAtLeast(2021, 11, 0)
        val canRegisterEntityDisabledState = isHomeLandVersionAtLeast(2022, 6, 0)
