package io.homeland.companion.android.common.data.websocket.impl
...
import io.homeland.companion.android.common.data.authentication.AuthorizationException
...
import io.homeland.companion.android.common.data.websocket.WebSocketRequest
...
import io.homeland.companion.android.common.data.websocket.impl.entities.EventResponse
import io.homeland.companion.android.common.data.websocket.impl.entities.GetConfigResponse
import io.homeland.companion.android.common.data.websocket.impl.entities.SocketResponse
...
class WebSocketRepositoryImpl @Inject constructor(
    ...
    private var connectionHaVersion: HomeLandVersion? = null
    ...
    private fun handleAuthComplete(successful: Boolean, haVersion: String?) {
        connectionHaVersion = haVersion?.let { HomeLandVersion.fromString(it) }
        if (successful) {
