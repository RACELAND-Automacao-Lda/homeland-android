...
class NetworkSensorManager : SensorManager {
    companion object {
        ...
        val publicIp = SensorManager.BasicSensor(
            ...
            "mdi:ip",
            docsLink = "https://companion.home-land.io/docs/core/sensors#public-ip-sensor",
            entityCategory = SensorManager.ENTITY_CATEGORY_DIAGNOSTIC
        )
        val networkType = SensorManager.BasicSensor(
            ...
            "mdi:network",
            docsLink = "https://companion.home-land.io/docs/core/sensors#network-type-sensor",
            entityCategory = SensorManager.ENTITY_CATEGORY_DIAGNOSTIC,
            updateType = SensorManager.BasicSensor.UpdateType.INTENT
        )
    ...
    override fun docsLink(): String {
        return "https://companion.home-land.io/docs/core/sensors#connection-type-sensor"
    }
