...
import io.homeland.companion.android.common.util.databaseChannel
...
import io.homeland.companion.android.database.notification.NotificationItem
import io.homeland.companion.android.database.qs.TileDao
import io.homeland.companion.android.database.qs.TileEntity
import io.homeland.companion.android.database.sensor.Attribute
import io.homeland.companion.android.database.sensor.EntriesTypeConverter
...
import io.homeland.companion.android.database.sensor.SensorSetting
import io.homeland.companion.android.database.sensor.SensorSettingTypeConverter
import io.homeland.companion.android.database.settings.LocalNotificationSettingConverter
import io.homeland.companion.android.database.settings.LocalSensorSettingConverter
import io.homeland.companion.android.database.settings.Setting
...
import io.homeland.companion.android.database.wear.Favorites
...
import io.homeland.companion.android.database.widget.ButtonWidgetEntity
import io.homeland.companion.android.database.widget.CameraWidgetDao
import io.homeland.companion.android.database.widget.CameraWidgetEntity
import io.homeland.companion.android.database.widget.MediaPlayerControlsWidgetDao
import io.homeland.companion.android.database.widget.MediaPlayerControlsWidgetEntity
import io.homeland.companion.android.database.widget.StaticWidgetDao
import io.homeland.companion.android.database.widget.StaticWidgetEntity
import io.homeland.companion.android.database.widget.TemplateWidgetDao
import io.homeland.companion.android.database.widget.TemplateWidgetEntity
import io.homeland.companion.android.database.widget.WidgetBackgroundTypeConverter
...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        private const val DATABASE_NAME = "HomeLandDB"
        ...
        private fun notifyMigrationFailed() {
            ...
            runBlocking {
                try {
                    ...
                    Log.d(TAG, "Event sent to HomeLand")
                } catch (e: Exception) {
                    Log.e(TAG, "Unable to send event to HomeLand", e)
