...
import io.homeland.companion.android.viewHolders.HeaderViewHolder
import io.homeland.companion.android.viewHolders.InstanceViewHolder
import io.homeland.companion.android.viewHolders.LoadingViewHolder
import io.homeland.companion.android.viewHolders.ManualSetupViewHolder
import kotlin.math.min
import io.homeland.companion.android.common.R as commonR

class ServerListAdapter(
    val servers: ArrayList<HomeLandInstance>
) : RecyclerView.Adapter<ViewHolder>() {

    lateinit var onInstanceClicked: (HomeLandInstance) -> Unit
