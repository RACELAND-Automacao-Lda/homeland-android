package io.homeland.companion.android.phone
...
import io.homeland.companion.android.database.wear.getAll
import io.homeland.companion.android.database.wear.replaceAll
...
class PhoneSettingsListener : WearableListenerService(), DataClient.OnDataChangedListener {
    ...
    private fun login(dataMap: DataMap) = mainScope.launch {
        try {
            ...
            Log.e(TAG, "Unable to login to HomeLand", e)
        }
