...
fun getIcon(entity: Entity<Map<String, Any>>?, domain: String, context: Context): IIcon? {
    ...
    return if (icon?.startsWith("mdi") == true) {
         ...
         * https://github.com/home-land/frontend/blob/dev/src/common/entity/domain_icon.ts.
        ...
        when (domain) {
            ...
            "google_land" -> CommunityMaterial.Icon2.cmd_google_land
            "group" -> CommunityMaterial.Icon2.cmd_google_circles_communities
            "homeland" -> CommunityMaterial.Icon2.cmd_home_land
